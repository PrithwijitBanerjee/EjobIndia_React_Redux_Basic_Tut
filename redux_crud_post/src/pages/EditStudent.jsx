...
import { editStudent, fetchSingleStudent } from "../redux/reducers/studentSlice";
...
const EditStudent = () => {
    ...
    const { student: myStudent, err, status } = useSelector(state => state?.allStudents);
    const [student, setStudent] = useState(initial_student);
    const [stuErr, setStuErr] = useState(initial_stu_err);
    ...
    const handleSubmit = async e => {
        ...
        if (Object.keys(errList).length === 0) {
            try {
                const res = await editStudent(id, student);
    ...
    useEffect(() => {
        if (status === STATUSES.IDLE && myStudent) {
            setStudent({
                name: myStudent.name,
                email: myStudent.email,
                phone: myStudent.phone,
                    ...
                    <div className="card" style={{ width: '30rem' }}>
                        <div className="card-body">
                            ...
                            <div className="card-text">
                                {
                                    err ? (<div className="text-danger">something went wrong</div>) : (<form onSubmit={handleSubmit}>
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                value={status === STATUSES.LOADING ? 'loading ...' : student.name}
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                value={status === STATUSES.LOADING ? 'loading ...' : student.email}
                                                onChange={handleInput}
                                            />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                value={status === STATUSES.LOADING ? 'loading ...' : student.phone}
                                                onChange={handleInput}
                                            />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                value={status === STATUSES.LOADING ? 'loading ...' : student.address}
                                                onChange={handleInput}
                                            />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                value={status === STATUSES.LOADING ? 'loading ...' : student.city}
                                                onChange={handleInput}
                                            />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                value={status === STATUSES.LOADING ? 'loading ...' : student.class}
                                                onChange={handleInput}
                                            />
